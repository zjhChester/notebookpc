...
//验证码
		...
		if($voteuser['openid']==$openid && empty($reply['isoneself'])){
			...
			if(($reply['isfollow']==0||$reply['isfollow']==2) && !empty($reply['followvote'])){
				$reply['everyonevote']=$reply['everyonevote']+$reply['followvote'];
				$reply['dailyvote']=$reply['dailyvote']+$reply['followvote'];
				$reply['everyoneuser']=$reply['everyoneuser']+$reply['followvote'];
			}
